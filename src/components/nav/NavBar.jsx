                ...
                <div className="navbar-item">
                  <div className="buttons">
                    {token ? (
                      ...
                      <>
                        <Link to="/register" className="button is-link mr-6 hover:text-fuchsia-600 transition border-b-2 border-slate-900 hover:border-fuchsia-600 cursor-pointer">
                          Register
                        </Link>
                        <Link to="/login" className="button is-outlined hover:text-fuchsia-600 transition border-b-2 border-slate-900 hover:border-fuchsia-600 cursor-pointer">
                          Login
                        </Link>
                      </>
                    )}
